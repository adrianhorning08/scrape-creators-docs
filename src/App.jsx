...
export default function App() {
  ...
  const isIntroduction = location.pathname === '/' || location.pathname === '/introduction';
  ...
  return (
    <main className="jsx-4145347147">
      <Helmet>
        ...
        <meta property="og:description" content="Official API documentation for Scrape Creators - Easily scrape data from social media platforms including TikTok, Instagram, YouTube, and more." />
        <meta property="og:image" content="https://scrapecreators.com/logo.png" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="Scrape Creators API Documentation" />
        <meta name="twitter:description" content="Official API documentation for Scrape Creators - Easily scrape data from social media platforms including TikTok, Instagram, YouTube, and more." />
        <meta name="twitter:image" content="https://scrapecreators.com/logo.png" />
      </Helmet>
          ...
          <div className="flex flex-row gap-12 box-border w-full pt-40 lg:pt-10">
            ...
            {!isIntroduction && (
              ...
              <div className="w-[28rem] gap-6 flex flex-col">
                {endpointData && <CodeBlock language="JavaScript" endpoint={endpointData} />}
                {endpointData && <CodeBlock language="200" endpoint={endpointData} />}
              </div>
              </div>
            )}
          </div>
