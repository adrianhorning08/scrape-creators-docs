export const getCurlExample = (endpoint, formState, inModal) => {
  ...
  return `<span class="token function">curl</span> <span class="token string">"https://api.scrapecreators.com${endpoint?.path || ''}${queryString}"</span> <span class="token punctuation">\\</span>
